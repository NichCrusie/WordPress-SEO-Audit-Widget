...
function seo_audit_shortcode() {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['url'])) {
        ...
        $keyword_usage_check = check_keyword_usage($html, $target_keyword); // Use provided keyword
        ...
        // Checks: Title, Meta Description, H1 Tag, H2 Tags, Images Alt Tags, and more
...
// Display individual audit check result
...
// Check for XML sitemap presence in robots.txt
...
// Check for presence of social media links
